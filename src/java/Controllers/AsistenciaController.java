...
public class AsistenciaController implements Serializable {
    ...
    public String eventon(String evento) {
        evento = "Programing";
        return evento;
    }
    ...
    //====================Metodo traido del facade
    public List<Asistencia> getAsistenciasByAprendiz() {
        items = null;
        Login personaLogin = new Login();
        items = getFacade().getAsistenciasAprendiz(personaLogin.usuarioSesion().getPersonaIdPersona().getIdPersona());
        System.out.print(personaLogin.usuarioSesion().getPersonaIdPersona().getIdPersona());
        return items;
    ...
    public static class AsistenciaControllerConverter implements Converter {//Acceso concedido a estepc
    ...
    public String disableenablebutton(String page) {
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_FATAL, "Por favor selecione una lsita", "Por favor selecione una lsita"));
    ...
    public List<Asistencia> llenarasistencia() {
        visible = 1;
        items = ejbFacade.obtenerasistencia(id);
        return items;
    }
    
    public List<Asistencia> llenarasistencia2() {
        EventosController eventoId = new EventosController();
        items = ejbFacade.obtenerasitencia(eventoId.getIdEventos());
        return items;
    }
}
